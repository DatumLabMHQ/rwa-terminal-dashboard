...
import { ArrowSquareOutIcon, BankIcon, BookOpenIcon, CaretRightIcon, ChartLineUpIcon, CoinsIcon, GlobeHemisphereWestIcon, SquaresFourIcon, TableIcon, UsersThreeIcon, VaultIcon } from '@phosphor-icons/react';
...
const ICONS: Record<string, React.ReactNode> = { '/': <SquaresFourIcon />, '/markets': <TableIcon />, '/vaults': <VaultIcon />, '/horizon': <BankIcon />, '/assets': <CoinsIcon />, '/curators': <UsersThreeIcon />, '/chains': <GlobeHemisphereWestIcon />, '/methodology': <BookOpenIcon /> };
